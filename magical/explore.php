...
<body>
    ...
    /* Style for the different types of interactions */
    ...
    /* Style for individual interaction lists */
    .data-list {
    ...
    /* Apply styles to different interaction types */
    #experimentally-validated {
    ...
    .data-paragraph {
      color: #1976D2; /* Blue paragraph color */
    }

    /* Styles for the GI retrieval section */
    #gi-retrieval {
      margin-top: 20px;
      padding: 10px;
      border: 1px solid #ccc;
    ...
    #gi-retrieval-heading {
      color: #ff7043; /* Orange heading color for GI retrieval section */
      font-size: 20px;
      margin-bottom: 10px;
    }

    #experimentally-validated-gis,
    #predicted-gis,
    #all-possible-gis {
      margin-top: 15px;
      padding: 8px;
    ...
    /* Apply styles to different GI retrieval types */
    #experimentally-validated-gis {
      background-color: #ffe0b2; /* Light orange background */
    }
...
<div class="data-container">
    <div class="data-heading">Allows one to retrieve GIs from sets of data</div>

    <!-- ... (your existing content) ... -->

    <!-- GI Retrieval Section -->
    <div id="gi-retrieval">
      <div id="gi-retrieval-heading">Genetic Interactions Retrieval</div>

      <div id="experimentally-validated-gis" class="data-paragraph">
        Pairs identified by Experimentally validated PPIs
        <!-- Include your list of Experimentally validated GIs here -->
      </div>

      <div id="predicted-gis" class="data-paragraph">
        Predicted PPI
        <!-- Include your list of Predicted GIs here -->
      </div>

      <div id="all-possible-gis" class="data-paragraph">
        Interactions generated from all possible pairwise combinations of proteins
        <!-- Include your list of All Possible GIs here -->
      </div>
    </div>
	<br>

    <!-- ... (continue with the rest of the content, applying appropriate classes and IDs) ... -->
